<template>
  <transition name="dialog-fade">
    <!-- gray mask -->
    <div class="cs-dialog__wrapper" v-show="visible" @click.self="_handleClose">
      <!-- real content -->
      <div class="cs-dialog" :style="{ width: width, marginTop: top }">
        <!-- header -->
        <div class="cs-dialog__header">
          ...
          <span class="cs-dialog__headerbtn" @click.self="_handleClose">x</span>
        </div>
        <!-- body -->
